...
export const CONVERSATION_TASKS = Object.freeze([
  {node: "prologue-wake", target: "prologue-briefing", type: "conversation",
    ...
    actions: [{id: "surface-briefing", label: "与小周交谈",
      ...
      text: "【小周】我是公司的安全联络员。你最近的记忆出了问题，先别急着勉强自己。石涧村最近不断出现白灯、夜间广播和脚印，公司希望查清是谁在借项目制造混乱。我们先从这些怪事查起。"}]},
  {node: "prologue-belongings", target: "prologue-key-and-memory", type: "conversation",
    ...
    choicePrompt: {
      ...
      text: "【小周】他把那把旧钥匙递到你面前，却没有立刻松手。"
    },
    actions: [
      {id: "receive-key", label: "接过小周递来的旧钥匙", facts: ["key-a-given-by-x"],
        text: "【小周】这是在你出事地点附近捡到的。先拿着，调查时可能用得上。\n他递来一把没有标记的老钥匙。你还不知道它能打开什么。"},
