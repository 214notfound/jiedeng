...
export const teamData = {
  ...
  divisions: {
    "luo-chenfei":
      "罗晨菲：V1 全局、主菜单、页面导航与存档；V2 全局状态、存档、错误处理与正式集成；V4 全局状态协调，以及素材、视频、音效的接入。",
    "yang-meng":
      "杨梦：V1 入口与核心视觉；V2 场景美术、素材与视觉验收；V3 场景美术、视觉、音效，以及剧情展示与剧情回归；V4 页面切换转场素材、亮灯与结局剧情视频、音频素材及其接入。",
    "gao-bingxuan":
      "高冰轩：V1 Mini-game、项目介绍与制作组页面；V2 游戏页面、统一阅读组件、响应式与地图容器；V3 全局协调、状态存档、游戏页面与统一阅读组件；V4 3 个 Mini-game 的设计与完善。",
    "lu-zhengsong":
      "卢正松：V1 场景探索、NPC 对话、背包与成就；V2 热点、对话、线索、背包与成就；V3 点击式探索、NPC 对话、线索、背包、成就及整体功能集成；V4 对话框设计、物品详情卡片与地图碎片图片替换、场景细节微调、背包与成就菜单页调整，以及与视频衔接的场景调整。",
    "yu-zhirang":
      "于知让：V1 账户与剧情模块；V2 剧情 Node、剧情展示与剧情回归；V4 剧情对话完善。"
  },
